...
It should be similar to mini_magick, with the following differences:

* More relihable. It threads warnings as errors, it does not mess up metadata when warnings occur.
